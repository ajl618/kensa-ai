...
docker-tag:
	docker tag kensa-ai:latest jimlu/kensa-ai:latest
	docker tag kensa-ai:latest jimlu/kensa-ai:0.1.0

docker-push: docker-tag
	docker push jimlu/kensa-ai:latest
	docker push jimlu/kensa-ai:0.1.0
